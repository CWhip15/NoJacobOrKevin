...
// // State variables of last button reads
// boolean btnHomeWasPressed = false;
...
// ///////////////////////////////////////////////////////////////
// void loop() {
//     // Read in button data and store; update beep status
//     M5.update(); // Reads data
//     M5.Beep.update();
//     boolean btnHomeIsPressed = M5.BtnA.isPressed();

//     // If button was just pressed/released, update mode and button state
//     if (!btnHomeIsPressed && btnHomeWasPressed) {
//         isGraphMode = !isGraphMode;
//         M5.Beep.setBeep(1000, 100);
//         M5.Beep.beep();
//     }
//     btnHomeWasPressed = btnHomeIsPressed; // Save the current button state into the last button state
